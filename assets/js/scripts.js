...
*************************************************** **/
	...
	jQuery(window).ready(function () {
		...
		// Load Bootstrap JS
		loadScript(plugin_path + '../js/bootstrap.min.js', function() {
		...
		if(jQuery("body").hasClass("smoothscroll") && navigator.platform.indexOf('Mac') < 0) {
			...
			loadScript(plugin_path + '../js/smoothscroll.js', function() {
				jQuery.smoothScroll();
			});
 ...
 **************************************************************** **/
	function _onepageNav() {
		...
		if(_container1.length > 0) {
			...
			loadScript(plugin_path + '../js/jquery.nav.min.js', function() {
 ...
 **************************************************************** **/
	function _owl_carousel() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path + '../js/owl.carousel.min.js', function() {
 ...
 **************************************************************** **/
	function _lightbox() {
		...
		if(_el.length > 0) {
			...
			loadScript(plugin_path + '../js/jquery.magnific-popup.min.js', function() {
 ...
 **************************************************************** **/
	function _mixitup() {
		...
		if(_container.length > 0) {
			loadScript(plugin_path + '../js/jquery.mixitup.min.js', function() {
 ...
 **************************************************************** **/
	function _misc() {
		...
		if(file_container.length > 0) {
			loadScript(plugin_path + '../js/custom.fle_upload.js');
		}
 ...
 **************************************************************** **/
	function _form() {
		...
		if(jQuery('form.validate-plugin').length > 0) {
			...
			loadScript(plugin_path + '..js/jquery.form.min.js', function() {
				loadScript(plugin_path + '../js/jquery.validation.min.js');
			});
		...
		if(jQuery('form.validate').length > 0) {
			...
			loadScript(plugin_path + '../js/jquery.form.min.js', function() {
				loadScript(plugin_path + '../js/jquery.validation.min.js', function() {
